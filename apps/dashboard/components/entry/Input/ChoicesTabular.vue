...
import { ENTRY_PREFERENCES } from "./Root.vue";
import {
	Trash2Icon,
	CircleCheckIcon,
...
const columnsCount = ref(ENTRY_PREFERENCES.value.CHOICES_COLUMNS);
	...
	<div aria-role="tabular-question header" class="my-2">
		<div class="flex flex-col gap-2 mt-4 w-[calc(100%-68px)]">
			...
			<div
				class="grid gap-2"
				:style="{
					gridTemplateColumns: `repeat(${ENTRY_PREFERENCES.CHOICES_COLUMNS}, minmax(0, 1fr))`,
				}">
				<Input
