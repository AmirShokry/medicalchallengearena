...
<template>
  ...
  >
    <div class="flex items-center justify-between h-10 flex-wrap gap-2">
      <Label for="question">
        <span
          class="before:content-['Question'] @max-[150px]/question-input:before:content-['Q']"
        />
    ...
    <ImageUploadProvider :images="question.imgUrls">
      <div class="min-h-20 flex items-center gap-1 mt-4">
        <Textarea
          required
          form="submit-input"
