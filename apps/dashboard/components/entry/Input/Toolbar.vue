...
<template>
  <div class="flex h-9">
    ...
    <Dialog>
      <DialogTrigger tabindex="-1" class="ml-auto">
      ...
      <DialogContent class="max-w-2xl">
        ...
        <div class="grid grid-cols gap-2">
          ...
          <Select v-model="ENTRY_PREFERENCES.CASE_TYPE">
            ...
            <SelectContent>
              <SelectItem v-for="type in CASE_TYPES" :key="type" :value="type">
                {{ type }}
              </SelectItem>
            </SelectContent>
          </Select>
        ...
        <div class="grid grid-cols gap-2">
          ...
          <Input
            tabindex="-1"
            @update:model-value="(value) => hanldeQuestionsNumberChange(value)"
            @blur="
        ...
        <div class="grid grid-cols gap-2">
          ...
          <Input
            ...
            @update:model-value="(value) => handleChoicesChange(value, 'row')"
            @blur="
        ...
        <div class="flex flex-col gap-4">
          ...
          <div class="flex gap-2">
            <Slider
              ...
              :step="1"
            />
            <p class="text-sm">{{ ENTRY_PREFERENCES.INPUT_PANEL_SIZE[0] }}%</p>
          </div>
        </div>
        <DialogFooter>
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Applying these settings will refresh the page. Make sure to
