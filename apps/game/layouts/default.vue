...
window.addEventListener("scroll", () => {
	...
	if (window.scrollY > 0)
		return header.value.classList.add("header-scrolled");
	...
	<div class="min-h-svh relative flex flex-col">
			...
			<div
				...
				<nav class="h-full flex items-center max-md:hidden">
					<ul
						...
						<li class="hover:bg-muted px-1 rounded-sm">
							<a class="cursor-pointer" href="#">Courses</a>
						</li>
						<li class="hover:bg-muted px-1 rounded-sm">
							<NuxtLink
				...
				<UiDropdownMenu>
					...
					<UiDropdownMenuContent class="w-48 mx-4">
						<UiDropdownMenuItem>
							<a class="cursor-pointer text-lg" href="#">
								Courses
							</a>
						</UiDropdownMenuItem>
						<UiDropdownMenuItem>
		...
		<footer class="pt-6 pb-12 px-[min(6rem,6svw)] min-h-80">
			<div class="w-full min-h-80 flex max-lg:flex-col">
				<div
					class="flex-1 max-lg:order-3 order-1 font-geist flex flex-col">
					<p class="text-xl truncate w-90">
						yassin@medicalchallengearena.com
					</p>
					<div class="flex gap-2 items-center">
						<a
							href="https://discord.com/invite/nBj3EUJR"
							target="_blank">
						...
						<a
							href="https://www.youtube.com/@yassinbadr6564"
							target="_blank">
				...
				<div
					class="flex-2 max-lg:order-1 order-2 grid grid-cols-4 font-geist">
					<div>
						<p class="font-semibold mb-1">Product</p>
						<NuxtLink :to="{ path: '/', hash: '#pricing' }">
							Pricing
						</NuxtLink>
						<p>Features</p>
						<a
							href="https://stats.uptimerobot.com/iBklV0JKKN"
							target="_blank">
							Status
						</a>
						<p>Discounts</p>
					...
					<div>
						...
						<NuxtLink class="block" :to="links.contact">
							Contact
						</NuxtLink>
					</div>
					<div>
					...
					<div>
						...
						<NuxtLink class="truncate" :to="links.terms">
							Terms
						</NuxtLink>
				...
				<div class="flex-1 order-3 max-lg:order-2 flex flex-col gap-2">
					<div class="flex gap-1 items-center">
						...
						<select class="w-full mb-1">
							<option class="bg-primary-foreground" value="en">
								English
							</option>
							<option class="bg-primary-foreground" value="fr">
								Français
							</option>
							<option class="bg-primary-foreground" value="es">
								Español
							</option>
							<option class="bg-primary-foreground" value="de">
								Deutsch
							</option>
							<option class="bg-primary-foreground" value="ar">
								العربية
							</option>
							<option class="bg-primary-foreground" value="zh">
								中文
							</option>
						</select>
					</div>
