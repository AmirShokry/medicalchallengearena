...
function handleGoClick() {
	if (status.value === "authenticated") window.location.href = "/lobby";
...
<template>
	<div class="px-6 pb-10 font-geist">
		...
		<section
			...
			<div
				class="flex h-full py-[calc(4rem+6svh)] px-[clamp(1rem,4svw,6rem)]">
				<div class="flex-1 flex flex-col gap-4">
					...
					<div
						class="flex gap-6 max-lg:flex-col w-full px-2 flex-wrap">
						<div
							...
							<p
								class="border border-border my-2 group-hover:border-white"></p>
							<ul class="text-base">
							...
							<a
								...
								target="_blank">
								<UiButton class="mt-auto cursor-pointer">
									Subscribe
								</UiButton>
							</a>
						</div>
						<div
							...
							<p
								class="border border-border my-2 group-hover:border-primary"></p>
							<ul class="text-base">
